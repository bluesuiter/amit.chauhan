        ...
        <Nav id="sideNav" className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
            <div class="col-10 text-center" href="#page-top">
                ...
                <div className="py-1 rounded social-icons">
                    <NavLink className="social-icon" target="_blank" to='https://in.linkedin.com/in/chauhanamit0810'><i className="fab fa-linkedin-in"></i></NavLink>
                    <NavLink className="social-icon" target="_blank" to='https://github.com/bluesuiter'><i className="fab fa-github"></i></NavLink>
                    <NavLink className="social-icon" target="_blank" to='https://twitter.com/chauhanamit0810'><i className="fab fa-twitter"></i></NavLink>
                </div>
            </div>
